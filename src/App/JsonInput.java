    ...
    public static ArrayList<Account> deserializeAccounts() {
        ...
        try {
            ...
            for (int i=0; i < accountsArray.length(); i++) {
                ...
                // Characters
                ArrayList<Entities.Character> characters = new ArrayList<>();
                try {
                ...
                Account.Information information = new Account.Information.InformationBuilder().name(name)
                        .country(country)
